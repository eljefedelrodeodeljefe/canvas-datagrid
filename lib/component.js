...
define(['./defaults'], function (defaults) {
  ...
  return function () {
    ...
    component.getObservableAttributes = function () {
      var i = {}; var attrs = ['data', 'schema', 'style', 'className', 'name']
      defaults(i)
    ...
    component.attributeChangedCallback = function (attrName, oldVal, newVal) {
      ...
      if (/^on/.test(attrName)) {
        // TODO(eljefedelrodeodeljefe): remove eval if possible
