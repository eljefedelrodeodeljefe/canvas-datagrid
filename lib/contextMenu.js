...
/* globals requestAnimationFrame: false, Event: false */
import { maybeInjectPassive } from './helpers'

export default function contextMenu (self) {
  ...
  function createFilterContextMenuItems (e) {
    ...
    var filterAutoCompleteButton = document.createElement('button')
    var filterInput = document.createElement('input')
    var n = e.cell && e.cell.header ? e.cell.header.title || e.cell.header.name : ''
