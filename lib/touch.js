...
/* globals requestAnimationFrame: false, performance: false */
export default function touch (self) {
  var touchTimerMs = 50
  // var debounceTouchMove
  var touchMoving
  var touchScrollTimeout
  ...
  self.touchEndAnimation = function () {
    ...
    var d = self.attributes.touchReleaseAnimationDurationMs
    var t
  ...
  self.touchCell = function (e) {
    return function () {
      ...
      var i; var pos = self.getTouchPos(e)
  ...
  function touchMove (e) {
    ...
    function touchScroll () {
      ...
      var y = self.scrollBox.scrollTop
