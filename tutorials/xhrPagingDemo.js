/* jslint browser: true */
/* globals canvasDatagrid: false, alert: false */
function demo () {
  'use strict'
  var grid; var dataCache; var scrollDebounce; var loadingText = 'Loading...'
  ...
  function dataAdapter (offset, rows, callback) {
    ...
    var url; var xhr = new window.XMLHttpRequest()
  ...
  grid.addEventListener('scroll', function () {
    ...
    scrollDebounce = setTimeout(function () {
      ...
      if (grid.data.filter(function (d, i) {
        ...
        var rows = grid.scrollIndexRect.bottom - grid.scrollIndexRect.top
