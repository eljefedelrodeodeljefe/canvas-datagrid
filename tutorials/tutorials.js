/* jslint browser: true */
/* globals canvasDatagrid: false, alert: false, Image: false */
window.tutorials = {}
window.tutorials['Create a new grid|A grid is created and data is set in one command.  Data can be an array of objects, an array of arrays or a mixed array of objects, arrays and primitives.'] = function (parentNode) {
  // create a new grid
...
window.tutorials['Set data after instantiation|A grid is created, then data is set afterwards.  You can set data using <i>grid.data = &lt;data&gt;;</i> at anytime.  Data can be an array of objects, an array of arrays or a mixed array of objects, arrays and primitives.'] = function (parentNode) {
  // create a new grid
  var grid = canvasDatagrid({
    parentNode: parentNode
  })
...
window.tutorials['Format data using rendertext event|Attach to the <i>rendertext</i> event.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 1501744914661, col3: 'a' },
...
window.tutorials['Use a textarea to edit cells instead of an input.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    multiLine: true,
    data: [
...
window.tutorials['Use select instead of input for edits|When a column in the schema includes an <i>enum</i> property, a drop down menu will appear instead of the normal input or textarea.'] = function (parentNode) {
  // eslint-disable-next-line no-unused-vars
  var grid = canvasDatagrid({
    parentNode: parentNode,
    schema: [
...
window.tutorials['Detect clicks|Detect which cell was clicked using the <i>click</i> event.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Detect cell over/out|Detect when a cell has been entered using <i>cellmouseover</i> and <i>cellmouseout</i> events.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Get data via XHR function.|Fetch data from data.gov and parse the JSON.'] = function (parentNode) {
  ...
  function parseOpenData (openData) {
    var data; var schema = openData.meta.view.columns
...
window.tutorials['Set filter function|By default, the filter is a RegExp string, you can alter this per data type by adding a function to the object <i>grid.filters.&lt;type&gt;</i>.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Simple context menu|Add your own items to the context menu.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Hierarchal context menus|Add hierarchal items to the context menu.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Context menu using a function for items|Instead of using an array, you can use a function that returns an array.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Asynchronous context items|Instead of an array, you can use a function that invokes a callback.  When you invoke the callback you pass an array to it to add items to the context menu asynchronously.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Remove context menu items|You can mutate the existing items in the context menu.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Create complex context menu|If you set the value of title to a HTML element reference, you can add complex functionality to the context menu.  To prevent the context menu from closing call <i>e.stopPropagation</i> on the object clicked on.'] = function (parentNode) {
...
window.tutorials['Alter runtime style|Change styles after the grid has been instantiated.  All styles can be changed at any time.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Canvas fill styles|An example of using complex fill styles on the canvas.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Replace all styles at runtime|Replace the entire style object at runtime.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Selection Mode Row|Prevents the selection of individual cells forcing the row to become selected.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Scroll to a cell'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Validate input|In this example, by using the <i>beforeendedit</i> event you can prevent digits from being entered.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
...
window.tutorials['Edit a cell|Use the interface to focus a cell, then begin editing a cell.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Set the width of a column'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Order by a column|By providing the order method with a column name and order (default ascending) you can change the sort order.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Select an area|Select an area of the grid using a <i>rect</i> object.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
...
window.tutorials['Remove all rows|Just get rid of all the data.  It is silly data anyway.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Allow new rows|Allow the input of new rows at the bottom of the grid.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Create a web component grid'] = function (parentNode) {
...
window.tutorials['Change a columns\'s title'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Add a column|There is also an insert version of this function.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Add a row|There is also an insert version of this function.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Draw HTML via Event|This draws HTML into an SVG object, takes a picture of it and caches it into the grid, then draws it into the cell.  In other words, it works, but it\'s slow.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Draw HTML via data type|This draws HTML into an SVG object, takes a picture of it and caches it into the grid, then draws it into the cell.  In other words, it works, but it\'s slow.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Open a tree|Open a tree grid on a specific row.  Use the <i>expandtree</i> event to control the data and settings of the tree grid.'] = function (parentNode) {
  function createData () {
    var x; var y; var d = []
    for (x = 0; x < 2000; x += 1) {
      d[x] = {}
...
window.tutorials['Allow users to open trees|Allows users to open trees.  Use the <i>expandtree</i> event to control the data and settings of the tree grid.'] = function (parentNode) {
  function createData () {
    var x; var y; var d = []
    for (x = 0; x < 2000; x += 1) {
      d[x] = {}
...
window.tutorials['Multiple filters|Create filters on more than one column at a time.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode
  })
  var x
...
window.tutorials['Toggle debug data|Show fun debugging information.  What are all these numbers?  File a bug ticket to find out!'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode,
    data: [
      { col1: 'foo', col2: 0, col3: 'a' },
...
window.tutorials['Display unicode samples|Unicode works if it is properly encoded using \\u escape sequences.'] = function (parentNode) {
  var grid = canvasDatagrid({
    parentNode: parentNode
  })
  grid.style.height = '300px'
...
window.tutorials['Create a spreadsheet|It\'s just like excel, but without all the useful parts.'] = function (parentNode) {
...
window.tutorials['Disco Mode|This is silly.  There is no way to stop it.'] = function (parentNode) {
